...
const I18N = {
  en: {
    ...
    // Reviews
    'rv.write': 'Write a review', 'rv.editTitle': 'Edit your review', 'rv.edit': 'Edit your review',
    'rv.textPh': 'Share your experience (optional)', 'rv.submit': 'Submit review', 'rv.delete': 'Delete review',
    'rv.saved': 'Thanks for your review!', 'rv.deleted': 'Review deleted',
    'rv.needRating': 'Please choose a star rating', 'rv.needLogin': 'Sign in to write a review',
    'rv.none': 'No reviews yet', 'rv.noneDesc': 'Be the first to share your experience.',
    ...
    'pf.pushNotif': 'Push Notifications',
    't.pushNotSupported': "Push isn't supported on this browser",
    't.pushNotConfigured': 'Push notifications are not configured yet',
    't.pushDenied': 'Blocked — enable notifications for this site in your browser settings',
  ...
  km: {
    ...
    // Reviews
    'rv.write': 'សរសេរមតិ', 'rv.editTitle': 'កែមតិរបស់អ្នក', 'rv.edit': 'កែមតិរបស់អ្នក',
    'rv.textPh': 'ចែករំលែកបទពិសោធន៍របស់អ្នក (មិនចាំបាច់)', 'rv.submit': 'ដាក់មតិ', 'rv.delete': 'លុបមតិ',
    'rv.saved': 'អរគុណសម្រាប់មតិរបស់អ្នក!', 'rv.deleted': 'បានលុបមតិ',
    'rv.needRating': 'សូមជ្រើសរើសផ្កាយវាយតម្លៃ', 'rv.needLogin': 'សូមចូលគណនីដើម្បីសរសេរមតិ',
    'rv.none': 'មិនទាន់មានមតិទេ', 'rv.noneDesc': 'ក្លាយជាអ្នកដំបូងដែលចែករំលែកបទពិសោធន៍។',
    ...
    'pf.pushNotif': 'ការជូនដំណឹង Push',
    't.pushNotSupported': 'Push មិនគាំទ្រនៅលើ browser នេះទេ',
    't.pushNotConfigured': 'Push notification មិនទាន់បានកំណត់រចនាសម្ព័ន្ធនៅឡើយទេ',
    't.pushDenied': 'ត្រូវបានទប់ស្កាត់ — សូមបើកអនុញ្ញាតការជូនដំណឹងសម្រាប់ site នេះក្នុង browser settings',
    't.pushEnabled': 'បានបើក Push notification ជោគជ័យ',
