...
import {
  getFirestore, collection, collectionGroup, getDocs, getDoc, doc, setDoc, addDoc, deleteDoc,
...
window.fs = { collection, collectionGroup, getDocs, getDoc, doc, setDoc, addDoc, deleteDoc, onSnapshot, query, orderBy };
